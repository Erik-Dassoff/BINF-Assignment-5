...
result1 <- lapply(pathfindR(DEGlistPathfindR, searchMethod1))
result2 <- pathfindR(DEGlistPathfindR, searchMethod2)

result1 <- lapply(DEGlistPathfindR, pathfindR)

is.numeric(DEGlistPathfindR$FEvsFC$adj.P.Val)

pathfindR()

DEGlistPathfindR.test <- as.data.frame(DEGlistPathfindR$FEvsFC)

class(DEGlistPathfindR.test)
run_pathfindR(DEGlistPathfindR.test)
